...
class PapersControllerTest < ActionController::TestCase
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post :create, paper: { author: @paper.author, keywords: @paper.keywords, name: @paper.name, references: @paper.references, topics: @paper.topics }
    end
  ...
  test "should update paper" do
    patch :update, id: @paper, paper: { author: @paper.author, keywords: @paper.keywords, name: @paper.name, references: @paper.references, topics: @paper.topics }
    assert_redirected_to paper_path(assigns(:paper))
  end
